  ...
  return (
    ...
    >
      ...
      <header className="container mx-auto px-4 py-6 flex justify-between items-center relative z-20">
        ...
        {/* ✅ FIXED: Desktop "Start Trading" button → goes to /login */}
        <motion.button
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6 }}
      ...
      {ismenuopen && (
        ...
        >
          <ul className="space-y-3">
            ...
            >
              {/* ✅ FIXED: Mobile "Start Trading" button → goes to /login */}
              <button
      ...
      <main className="container mx-auto px-4">
        ...
        <Animatedsection>
          <div className="text-center py-20">
            ...
            {/* ✅ FIXED: "Open Free Account" button → goes to /login */}
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              initial={{ opacity: 0, y: 20 }}
        ...
        <Animatedsection>
          <div className="bg-blue-600 rounded-2xl p-12 text-center py-12 relative overflow-hidden group">
            ...
            {/* ✅ FIXED: "Create Free Account" button → goes to /login */}
            <motion.button
